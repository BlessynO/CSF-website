      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start mb-24">
          ...
          <div className="w-full lg:w-1/2">
            <h4 className="text-burgundy font-bold uppercase tracking-wider mb-2">About Us</h4>
            ...
            <div className="bg-red-50 p-6 rounded-xl border border-red-100 mb-8">
              <h3 className="text-burgundy font-bold text-lg mb-3 flex items-center gap-2">
                <Globe className="w-5 h-5" /> The Global Challenge
              </h3>
            ...
            <button 
                ...
                className="flex items-center gap-2 text-burgundy font-bold border-2 border-burgundy px-6 py-3 rounded-full hover:bg-burgundy hover:text-white transition-all"
            >
        ...
        {showTeam && (
            <div className="mb-24 animate-fade-in bg-gray-50 rounded-3xl p-8 md:p-12">
                <div className="text-center mb-12">
                  <h3 className="text-3xl font-serif font-bold text-gray-900 mb-4">Our Executive Team</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-burgundy">
            <div className="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center text-burgundy mb-6">
          ...
          <div className="bg-burgundy text-white p-8 rounded-2xl shadow-lg relative overflow-hidden">
             <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-10 -mt-10" />
            <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center text-white mb-6 backdrop-blur-sm">
        ...
        {/* Strategy Pillars */}
        <div className="text-center mb-12">
            <h3 className="text-3xl font-serif font-bold text-gray-900">Our Strategy for Impact</h3>
            <p className="text-gray-500 mt-2">Built on three pillars to secure a healthier future.</p>
        </div>
        
        <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-gray-50 rounded-xl hover:bg-white hover:shadow-xl transition-all duration-300">
                <div className="text-brandRed font-bold text-xl mb-3">01</div>
                <h4 className="font-bold text-gray-900 mb-2">Promoting Equitable Access</h4>
                <p className="text-sm text-gray-600">Championing access to comprehensive health services and life-saving treatments for all, regardless of economic status.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-xl hover:bg-white hover:shadow-xl transition-all duration-300">
                <div className="text-brandRed font-bold text-xl mb-3">02</div>
                <h4 className="font-bold text-gray-900 mb-2">Supporting Global Management</h4>
                <p className="text-sm text-gray-600">Providing technical support to countries to develop robust national programs for prevention, screening, and management.</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-xl hover:bg-white hover:shadow-xl transition-all duration-300">
                <div className="text-brandRed font-bold text-xl mb-3">03</div>
                <h4 className="font-bold text-gray-900 mb-2">Driving Research & Innovation</h4>
                <p className="text-sm text-gray-600">Actively promoting research aimed at discovering new therapies and improving quality of life for those affected.</p>
            </div>
        </div>
